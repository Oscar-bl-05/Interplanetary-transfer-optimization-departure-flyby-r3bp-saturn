...
caseI_transfertime_multiplier = 1.25
caseII_transfertime_multiplier = 3 

T_transfer_case_I = caseI_transfertime_multiplier * cts.pi * sqrt((cts.R_orb_A + cts.R_orb_B)**3/(8*cts.mu_sun))
T_transfer_case_II = caseII_transfertime_multiplier * cts.pi * sqrt((cts.R_orb_A + cts.R_orb_B)**3/(8*cts.mu_sun))
